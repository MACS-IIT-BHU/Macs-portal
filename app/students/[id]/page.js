          ...
          <div className="h-full md:px-[100px]  flex flex-col ">
            <div className="flex flex-col md:flex-row gap-2 ">
              <div className="relative mt-10 grid place-items-center h-5/6 p-2  ">
                <div
                  className="h-[210px] w-[210px]   rounded-tl-[43px] rounded-tr-[75px] rounded-br-[43px] rounded-bl-[75px] shadow-md  overflow-hidden grid place-items-center 
                ...
                >
                  <div
                    className="h-[200px] w-[200px]   rounded-tl-[43px] rounded-tr-[75px] rounded-br-[43px] rounded-bl-[75px] shadow-md  overflow-hidden grid place-items-center 
                  ...
                  <>
                    {!editMode && (
                      <button
                        ...
                        className="border relative bg-blue-500 text-white mt-5 px-10 text-xl rounded-md"
                      >
                        Edit
                      </button>
                    )}
              ...
              <div className="relative grid place-items-center md:place-items-start md:flex md:flex-col w-full p-10 md:p-0 md:w-4/5 md:top-24 xl:top-36">
                ...
                {editMode ? (
                  ...
                  <>
                    ...
                    <div className="mt-4 text-xl p-2 text-black/40">
                      Skills: {user.skills}
                    </div>
                    ...
                    <div className="mt-4 flex gap-4 items-center justify-center">
                      ...
                      <div>
                        <a href={user.linkedin}>
                          <AiOutlineLinkedin size={30} color="skyblue" />
                        </a>
                      </div>
                    </div>
                  </>
