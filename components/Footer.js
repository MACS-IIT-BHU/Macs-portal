        ...
        <div className="flex flex-col space-x-4 space-y-3 mx-auto py-5">
          <div className="flex mx-auto gap-4">
            <div className="containimg">
              <a href="https://www.linkedin.com/in/macs-mathematics-and-computing-society-535735192">
                <svg
            ...
            <div className="containimg">
              <a href="https://www.facebook.com/macs.mat.iitbhu?mibextid=ZbWKwL">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  data-name="Layer 1"
                  viewBox="0 0 24 24"
            ...
            <div className="containimg">
              <a href="https://www.instagram.com/macs_iitbhu/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  data-name="Layer 1"
                  viewBox="0 0 24 24"
          ...
          <div className="flex gap-2 text-white font-montserrat text-xl font-normal">
            <a href="#">Contact us</a>
            <span>|</span>
            <a href="#">Support</a>
            <span>|</span>
