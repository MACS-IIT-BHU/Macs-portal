...
// import { _UilFacebookF } from '@iconscout/react-unicons'
const Footer = () => {
    return (
        <div className='bg-[#1E1E1E] min-h-[300px] flex flex-col gap-4 '>
            <div className="grid grid-cols-3 gap-4">
                <div className='mx-auto py-5'><img src="https://s3-alpha-sig.figma.com/img/f9e4/4697/f53ee055bd23e54abfaeba247328c934?Expires=1692576000&Signature=KhTIzdZbP2NypCb-9xJYSkcIH2hzv7twKqLm90cwrFiV3IFwbTXCFNwRJVVPlZTNBIaOOefA7kd22ctk3tEFsQcBuFNkYECeR0wliueZRcwtcqONMflYRQtLkxRPoSrBUkGitvCn-lRVqs-APpkKHtCFHYvYZRVs9AmPFwLTTFM0Z83fvDJ6H8~Vi759rLcLhElBtMETspYXi9twDyU8ZF1YgYE2065CEZxzppAEatqz6~8-kXSbbZg4EEgh70-I22KOad3BITBectmTDmqsg52Of0~hfJNAPH5cveDBV0YjRy4isLrE8eXUJ0CaYBEvdv7VgJuSJ82TxxfmuDFK~g__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" ></img></div>
                <div className="flex flex-col space-x-4 space-y-3 mx-auto py-20">

                    <div className='flex mx-auto gap-4'>&nbsp; &nbsp; 
                        <div className='containimg'><a href="#"><svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" id="linkedin"><path fill="#FFFFFF" d="M20.47,2H3.53A1.45,1.45,0,0,0,2.06,3.43V20.57A1.45,1.45,0,0,0,3.53,22H20.47a1.45,1.45,0,0,0,1.47-1.43V3.43A1.45,1.45,0,0,0,20.47,2ZM8.09,18.74h-3v-9h3ZM6.59,8.48h0a1.56,1.56,0,1,1,0-3.12,1.57,1.57,0,1,1,0,3.12ZM18.91,18.74h-3V13.91c0-1.21-.43-2-1.52-2A1.65,1.65,0,0,0,12.85,13a2,2,0,0,0-.1.73v5h-3s0-8.18,0-9h3V11A3,3,0,0,1,15.46,9.5c2,0,3.45,1.29,3.45,4.06Z"></path></svg></a></div>
                        ...
                        <div className='flex mx-auto gap-2 text-white' style={{
                            fontFamily: 'Montserrat',
                            fontSize: '18px',
                            fontStyle: 'normal',
                            fontWeight: '400',
                            lineHeight: '24.3px', /* 135% */

                        }}>
                            <a href="#">Contact us</a> - <a href="#">Support</a> - <a href="#">Services</a>
                        </div>
                        <div className='flex mx-auto text-white gap-2 ' style={{
                            fontFamily: 'Montserrat',
                            fontSize: '18px',
                            fontStyle: 'normal',
                            fontWeight: '400',
